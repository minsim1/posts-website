...
export const ErrorCodeMessages: Record<AllErrorCodes, string> = {
    ...
    [ErrorCode.Moderation.AUTHOR_ID_EXPUNGED]: "The author's user ID has been expunged.",

    [ErrorCode.Votes.VOTING_VIOLATES_LIMIT_RULES]: "Voting action violates the set limit rules.",
    ...
    [ErrorCode.Comments.POST_TOO_OLD_TO_COMMENT_ON]: "The post is too old to comment on.",
};